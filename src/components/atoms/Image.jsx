...
export const Image = ({ id, mobilesrcfile, tabletsrcfile, desktopsrcfile, height, width, className }) => {
  // TODO ADD IE fallback
  // TODO Check if Imgsrc can be added
  ...
  return (
    <PictureWrapper>
        ...
        <Img className={className} id={id} src={desktopsrcfile} height={height} width={width} />
    </PictureWrapper>
  );
};
