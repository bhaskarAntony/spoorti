...
export const Text = ({ bold, color, margin, size, text, tag, align, className, action }) => {
  return (
    <TextItem className={className} as={tag} size={size} color={color} margin={margin} align={align} bold={bold} onClick={action} >
      {text}
    </TextItem>
  );
};
