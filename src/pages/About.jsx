...
import { ContactDirectoriesWithImages } from "../components/organisms/ContactDirectoriesWithImages"
import ImageGallery from "../components/organisms/ImageGallery"
import aboutUsList from '../data/aboutUsList.json'
...
export const About = (props) => {
  ...
  return <CommonWrapper 
    ...
    >
      <ContentWrapper>
        <Breadcrumb currentPageName={language.list[1].label} />
        ...
        {aboutUsList.about_us.map((item, index) => {
          return (
            <CardImageWithText
              key={index}
        ...
        <ContactDirectoriesWithImages/>
        <ImageGallery bannerSlider = {aboutUsList.banners}/>
      </ContentWrapper>
    </CommonWrapper>
};
